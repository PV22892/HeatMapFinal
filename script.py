...
municipalities = {
    "Aveiro": {
        "Aveiro": {"lat": (40.6, 40.65), "lng": (-8.65, -8.6)},
    ...
    "Castelo Branco": {
        ...
        "Idanha-a-Nova": {"lat": (39.9, 39.92), "lng": (-7.25, -7.23)},
    },
    "Coimbra": {
        "Arganil": {"lat": (40.1, 40.4), "lng": (-8.1, -7.9)},
        "Coimbra": {"lat": (40.1, 40.3), "lng": (-8.5, -8.3)},
        "Cantanhede": {"lat": (40.3, 40.32), "lng": (-8.6, -8.58)},
    ...
    "Évora": {
        "Alandroal": {"lat": (38.6, 38.8), "lng": (-7.5, -7.3)},
    ...
    "Faro": {
        ...
        "Alcoutim": {"lat": (37.47, 37.49), "lng": (-7.45, -7.43)},
        "Aljezur": {"lat": (37.3, 37.32), "lng": (-8.8, -8.78)},
        "Castro Marim": {"lat": (37.2, 37.22), "lng": (-7.45, -7.43)},
        "Monchique": {"lat": (37.28, 37.3), "lng": (-8.5, -8.48)},
